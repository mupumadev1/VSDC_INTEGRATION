...
// Save the instance
    ...
    public void createPOInvoice(JsonNode sale, String ponumber,List<postPOItemsDTO>items){
        ...
        poinvn.setItemdesc(poporl.getItemdesc());
        poinvn.setStockunit("");
        poinvn.setRcpunit("");
        poinvn.setRcpconv(new BigDecimal("1.0"));
        poinvn.setRcpdecml((short) 4);
        poinvn.setRqreceived(new BigDecimal("1.0"));
        poinvn.setSqreceived(new BigDecimal("1.0"));
        poinvn.setOqreceived(new BigDecimal("1.0"));
        ...
        poinvn.setTfrecvamt1(new BigDecimal("0.0"));
