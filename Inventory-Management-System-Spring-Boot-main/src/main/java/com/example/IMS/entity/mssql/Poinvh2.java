...
public class Poinvh2 {
    ...
    @Column(name = "RTCODE", nullable = false, length = 6)
    private String rtcode;

    @Column(name = "RTDESC", nullable = false, length = 60)
    private String rtdesc;

    @Column(name = "RTADDRESS1", nullable = false, length = 60)
    private String rtaddress1;

    @Column(name = "RTADDRESS2", nullable = false, length = 60)
    private String rtaddress2;

    @Column(name = "RTADDRESS3", nullable = false, length = 60)
    private String rtaddress3;

    @Column(name = "RTADDRESS4", nullable = false, length = 60)
    private String rtaddress4;

    @Column(name = "RTCITY", nullable = false, length = 30)
    private String rtcity;

    @Column(name = "RTSTATE", nullable = false, length = 30)
    private String rtstate;

    @Column(name = "RTZIP", nullable = false, length = 20)
    private String rtzip;

    @Column(name = "RTCOUNTRY", nullable = false, length = 30)
    private String rtcountry;

    @Column(name = "RTPHONE", nullable = false, length = 30)
    private String rtphone;

    @Column(name = "RTFAX", nullable = false, length = 30)
    private String rtfax;

    @Column(name = "RTCONTACT", nullable = false, length = 60)
    private String rtcontact;
    ...
    @Column(name = "RTEMAIL", nullable = false, length = 50)
    private String rtemail;

    @Column(name = "RTPHONEC", nullable = false, length = 30)
    private String rtphonec;

    @Column(name = "RTFAXC", nullable = false, length = 30)
    private String rtfaxc;

    @Column(name = "RTEMAILC", nullable = false, length = 50)
    private String rtemailc;
