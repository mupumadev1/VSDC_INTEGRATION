...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "PORCPH1", schema = "dbo")
public class Porcph1 {
    @Id
    ...
    @Column(name = "LINESPRORA", nullable = false)
    private Integer linesprora;
    ...
    @Column(name = "COSTSPRORA", nullable = false)
    private Integer costsprora;

    @Column(name = "COSTSCMPL", nullable = false)
    private Integer costscmpl;

    @Column(name = "VENDS", nullable = false)
    private Integer vends;

    @Column(name = "VENDSCMPL", nullable = false)
    private Integer vendscmpl;

    @Column(name = "VENDSINVC", nullable = false)
    private Integer vendsinvc;

    @Column(name = "TAXLINES", nullable = false)
    private Integer taxlines;

    @Column(name = "EXTRANEOUS", nullable = false)
    private Integer extraneous;
    ...
    @Column(name = "PORS", nullable = false)
    private Integer pors;
    ...
    @Column(name = "BILLLINES", nullable = false)
    private Integer billlines;

    @Column(name = "COSTSBLPRO", nullable = false)
    private Integer costsblpro;
